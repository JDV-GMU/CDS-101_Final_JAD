...
```
Cut and Clarity do need to be changed into numeric values with as.numeric(factor()), and I have used levels to make sure that each category is properly organized in ascending quality.
