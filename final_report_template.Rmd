...
quantity of entries, there is a high density that would not be able to be 
explored efficiently with a point plot. The heat map shows the points with a
higher density of diamonds and lesser density of diamonds without 
getting muddled. 

- Comment on labels, legends, colors, and overall readability. 

The heatmaps show the density in different colors, making it more readible and 
understandable of the relationship. All graphs are labeled with accurate titles
and labels. 

- Mention any steps you took to make plots accessible and interpretable.
W
e chose to utilize a heat map instead of a normal point plot to make it more 
interpretable and accessible due to the sheer amount of entires. 
...
https://www.vrai.com/journal/post/diamond-carat-price
